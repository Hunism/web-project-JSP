	...
	%></em>
		...
		<div>
			...
			<tr>
				...
				<a href="/ShippingAction.pr?cartId=<%=shipping_cartId%>"class="btn btn-secondary" role="button"> 이전 </a>
				<a href="/ThankAction.pr"  class="btn btn-success" role="button"> 주문 완료 </a>
				<a href="/CancelledAction.pr" class="btn btn-secondary"	role="button"> 취소 </a>			
		</div>
	</div>	
</body>
</html>
